...
каждого из десяти старых генераторов дают 6344 различных раскладки, при этом
шесть из десяти генераторов заканчиваются к четырёхсотому броску (у mining
outpost всего 44 формы, у lab block — 56). Потолок синтетики — около 11M токенов.
Человеческие чертежи с `factorioprints.com` добавляют ещё ~7.8M. Вместе 18.8M
