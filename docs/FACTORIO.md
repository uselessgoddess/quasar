...
Форма кривой та же, что в §2 — 96% падения за первые 40% шагов, — и вывод из §4
она подтверждает: 10.2M токенов против 9.17M, лосс упал ниже прежнего (0.0723
против 0.1268), расхождения train/valid по-прежнему нет. Более разнообразный
